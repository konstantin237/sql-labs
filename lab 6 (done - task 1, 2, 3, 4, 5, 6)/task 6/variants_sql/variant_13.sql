...
-- 8. "Вывести количество студентов, количество преподавателей и
-- ко. "личество дисциплин."

SELECT s.cnt_students, t.cnt_teachers, d.cnt_disciplines
FROM (SELECT COUNT(*) AS cnt_students FROM students) s,
     (SELECT COUNT(*) AS cnt_teachers FROM teachers) t,
     (SELECT COUNT(*) AS cnt_disciplines FROM disciplines) d;
